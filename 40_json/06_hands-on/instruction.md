# JSON Hands-on Exercise

## In an HTML file

Create an array to hold objects in JavaScript.

Each object should store a "Code" as a number and "Descrip" as a strings.
...
Store a raw string literal of JSON created in the previous step as the value of variable "rcvd".
