...
import (
	...
	"github.com/ChenYenDu/GoWebDev/42_mongodb/08_hands-on_03/starting-code/models"
	"github.com/ChenYenDu/GoWebDev/42_mongodb/08_hands-on_03/starting-code/session"
...
func (c Controller) SignUp(w http.ResponseWriter, req *http.Request) {
	...
	if req.Method == http.MethodPost {
		...
		http.SetCookie(w, ck)
		session.Sessions[ck.Value] = models.Session{UserName: un, LastActivity: time.Now()}
